...
const DEFAULT_REQUIREMENTS := {
	...
	"res://src/combat/combat_runtime.gd": ["@export var impact_vfx_lifetime_seconds := 1.3", "@export var impact_vfx_surface_offset := 0.05"],
