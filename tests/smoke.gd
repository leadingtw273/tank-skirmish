...
func _validate_tank_inertia(instance: Node) -> bool:
	...
	if not is_equal_approx(tank.reverse_movement_speed, 5.0) \
		...
		return false
	if not is_equal_approx(tank._movement_speed_limit_for_turn(1.0, 0.0), tank.movement_speed) \
			or not is_equal_approx(tank._movement_speed_limit_for_turn(1.0, 0.5), tank.movement_speed * 0.75) \
			or not is_equal_approx(tank._movement_speed_limit_for_turn(1.0, 1.0), tank.movement_speed * 0.5) \
			or not is_equal_approx(tank._movement_speed_limit_for_turn(-1.0, 0.0), tank.reverse_movement_speed) \
			or not is_equal_approx(tank._movement_speed_limit_for_turn(-1.0, 0.5), tank.reverse_movement_speed * 0.75) \
